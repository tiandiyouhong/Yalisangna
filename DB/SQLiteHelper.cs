...
namespace DBCenter
{
    ...
    public static class SQLiteHelper
    {
        ...
        static string connectionString = "D:\\test\\ppdai.db";// "Data Source=ppdai.db;Version=3;FailIfMissing=True"; //ConfigurationSettings.AppSettings["SQLiteConnectionString"];
        ...
        public static DataSet ExecuteDataSet(SQLiteCommand cmd,string path)
        {
            DataSet ds = new DataSet();
            // SQLiteConnection con = new SQLiteConnection(connectionString);

            SQLiteConnection con = new SQLiteConnection(path);// "Data Source = D:\\test\\0000000000000000充电数据记录.db;");
            //con.Open();
            SQLiteTransaction trans = null;
            PrepareCommand(cmd, con, ref trans, false, cmd.CommandType, cmd.CommandText);
            try
